...
\includepdf[pages={1},offset=80 -80]{statutory.pdf}

%% ----------------------------------------------------------------
% \lhead{\emph{Contents}}  % Set the left side page header to "Contents"

% Очистить текущие колонтитулы
\fancyhf{}

% Верхний колонтитул (по центру) — название главы
...
\input{Chapters/Introduction/intro} % Introduction
...
\input{Chapters/DeliveryGuarantees/delivery}
...
\input{Chapters/DeterministicModelRuntime/deterministic}

\chapter{Substream Management}
\label{thesis-chapter-substreams-consistency}
% \lhead{\emph{Substream Management}}
\input{Chapters/SubstreamConsistency/substream}

\chapter{Tracker: A Substream Management Framework}
\label{thesis-chapter-tracker}
% \lhead{\emph{Tracker: A Substream Management Framework}}
\input{Chapters/Tracker/tracker}
