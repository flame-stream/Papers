...
% This distinction implies major problems in distributed stream processing. 
...
% Latency is one of the key metrics in stream processing since the freshness of results is usually valuable. 
