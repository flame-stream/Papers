...
\author{Igor E. Kuralenok\inst{1}
       \and Artem Trofimov\inst{1,2}
       \and Nikita Marshalkin\inst{1,2}
...
We introduce a model based on MapReduce-complete set of operations that allows us to achieve determinism and low-latency.
...
\keywords{Data streams  \and Distributed processing \and Latency.}
\end {abstract}
