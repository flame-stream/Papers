...
\input {fs-run-time-data-flow.tex}

\section {Graph and partitioning}
\input {fs-run-time-graph.tex}

\section {Ordering model}
\input {fs-run-time-timing.tex}

\section {Operations}
\input {fs-run-time-ops.tex}

\section {MapReduce transformations on stream}
\input {fs-run-time-mapreduce.tex}

\section {Optimistic collision management}
\input {fs-run-time-collision.tex}

\section {Barrier}
\input {fs-run-time-barrier.tex}
