...
Each map operation can produce multiple items from one. To differentiate them an ordinal number, {\it child id}, is stored in the meta information. {\it ChildIds} is an array of child ids, that corresponds to all visited map operations.
