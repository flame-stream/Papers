...
An important special case of grouping with $Window Size = 2$  provides for realization of stateful calculations with drifting state technique manifested in section~\ref{motivation-section}.  
...
There are four types of data items in this stream: {\em input,} {\em mapped,} {\em accumulator,} and {\em reduced.} 
