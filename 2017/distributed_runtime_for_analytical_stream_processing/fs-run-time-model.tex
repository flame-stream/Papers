...
\label {fs-model}
In this section we describe the outline of the proposed system. We focus on the core concepts and definitions. Such model is in line with common stream processing systems but has some radical differences: the strict ordering model and reduced operation set.
