...
While this methods are commonly adapted in practice we find them to have unpredictable latencies and to have bursty loads. In our system we employ an optimistic approach for handling out-of-order items.
