...
A tombstones for an item is the same item marked with a flag in its meta-information, hence it traverse over the same path in the logial graph as the invalidated item.
