...
In \FlameStream\ this algorithm is implemented as the typical conversion of MapReduce transformation, which is shown in the section~\ref{fs-map-reduce}. Inverted index structure plays the role of accumulator, and the last map operation produces the most recent changes of this structure, if any.
