...
Regarding overhead, we take the ratio of arrived at the barrier items count to the number of the valid items among them as a key metric. This value clearly represents the extra cost of our approach.
