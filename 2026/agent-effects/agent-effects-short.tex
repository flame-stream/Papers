...
argue these failures form one catalog, with three sources.
...
levels~\cite{berenson1995critique,adya1999}. The mechanisms are familiar;
...
rejected discovery with HTTP 401 or 403. Of these targets, 4{,}838 returned
...
tool was called. Code, data,
and full methodology are available in the accompanying
artifact.\footnote{\url{https://github.com/REPLACE-ME/mcp-annotation-census}} For each tool we recorded the four annotations the
