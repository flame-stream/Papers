...
\begin{table}[htbp]
\caption{Race effects }
\begin {tabular} {r | r | r}
Cluster size    & \% of varied labels (mean$\pm$std) & Accuracy \%   \\
\hline
\multicolumn {3}{c} {Multi-class model (accuracy 77.3)}  \\
2   &   $0.9\pm0.2$    &   $77.3\pm0.2$    \\
4   &   $1.7\pm0.4$    &   $77.3\pm0.2$    \\
8   &   $1.9\pm0.5$    &   $77.3\pm0.2$    \\
\hline
\multicolumn {3}{c} {Binary model for topic {\em Society} (accuracy 89.0)}  \\
2   &   $0.3\pm0.1$    &   $88.9\pm0.1$    \\
4   &   $0.4\pm0.2$    &   $89.0\pm0.1$    \\
8   &   $0.6\pm0.2$    &   $89.0\pm0.1$    \\
\hline
\multicolumn {3}{c} {Binary model for topic {\em Weapons} (accuracy 98.0)}  \\
