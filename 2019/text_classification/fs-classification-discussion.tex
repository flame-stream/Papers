...
\begin{table}[htbp]
\caption{Effects of races within multi-class model}
...
\begin{table}[htbp]
\caption{Effects of races within binary model for topic {\em Society}}
\begin{threeparttable}
\begin{tabular}{lcl}
Cluster size    & \% of varied labels (mean$\pm$std) & Accuracy    \\
\hline
...
\begin{table}[htbp]
\caption{Effects of races within binary model for topic {\em Weapons}}
\begin{threeparttable}
\begin{tabular}{lcl}
Cluster size    & \% of varied labels (mean$\pm$std) & Accuracy    \\
\hline
