...
\begin{enumerate}
    ...
    \item {\bf Network traffic complexity quadratically depends on the number of processes.} .
\end{enumerate}

\begin{lemma}
Punctuations framework does not support cycles.
\end{lemma}
\begin{proof}
...
\begin{lemma}
Network traffic complexity for this method is $O(K|\Pi|^2)$, where $|\Pi|$ is the number of processes and $K$ is the number of substreams.
\end{lemma}
\begin{proof}
