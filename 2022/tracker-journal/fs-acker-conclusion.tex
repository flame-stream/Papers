...
% The centralized agent is a limitation of a solution presented in this paper. The first problem is scalability. Due to the page limit, we omitted the discussion about the distributed \tracker\ agent. 
