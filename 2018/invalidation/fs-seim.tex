...
How this problem can be solved using Flink, Storm, etc.?

\section{Optimistic approach}
The main idea of our technique. Working example - grouping. Barrier as a single point of locking.

\section{Experiments}
Show that our idea works.
