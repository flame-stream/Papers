...
\begin{abstract}
Exactly-once semantics without high latency overhead is still impossible to achieve within state-of-the-art stream processing systems. In this paper we propose an architecture that provides for exactly-once using lightweight optimistic approach for obtaining determinism and idempotence.
\end {abstract}
