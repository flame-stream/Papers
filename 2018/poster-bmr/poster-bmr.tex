...
\begin{minipage}[t]{\twocolwidth}
  \begin{minipage}[t]{\colwidth}
    ...
    It immediately processes input items as they were in-order. I case of reordering it is locally generates correct tuples and sends tombstones for incorrect ones. 
