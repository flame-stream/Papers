...
\begin{document}
  ...
  \begin{minipage}[t]{\twocolwidth}
    \begin{minipage}[t]{\colwidth}
      ...
      \fspic[.8]{grouping-invalidation}{On arrival of out-of-order item, it is inserted in the correct location of the correcponding bucket. Valid elements containing new item are produced, and invalid ones are invalidated by sending a tombstone for it down the stream}
