...
Regarding future work, we plan to design distributed version of ~\Acker\ and to adopt drifting state model for iterative stream processing. This task seems natural for our model, because it already handles cycles in a data flow. 