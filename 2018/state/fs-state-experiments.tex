...
\subsection{Overhead}
The performance of the proposed deterministic model within the same stream processing task is deeply analyzed in~\cite{we2018seim}. In this paper we aim to evaluate the overhead on providing consistency guarantees.
