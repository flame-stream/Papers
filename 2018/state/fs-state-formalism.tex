...
% Прожевать цепочку. Введя референс систему мы ввели понятие валидности. Мы вводим ограничение на функционирование системы не напрямую, а через выход. В реальных системах, напрмер, часть функционирования, которая влияет на выход - это восстановление. Пример.
