    ...
    \Process {Barrier}
      ...
      \Event{$\langle Ack, t\rangle$}
        ...
        \If {$postponedCommitTime < lastAcknowledgedTime$}
          \State \Call{Send}{$acker, \langle Committed, self, postponedCommitTime \rangle$}
          \State $postponedCommitTime \gets \infty$
        \EndIf
      \EndEvent
    \EndProcess
