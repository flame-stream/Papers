...
In our system paradigm we need to define a system event, that indicates the bound of a substream for a process. We call this termination event or end-of-substream event
