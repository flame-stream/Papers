...
\begin{itemize}
    \item Deterministic\footnote{given the same sequences of input tuples, the same output tuples will be produced} windowed join requires an order of termination signals to respect the order of input elements (termination events from data producers)~\cite{najdataei2019stretch, gulisano2016scalejoin}.
