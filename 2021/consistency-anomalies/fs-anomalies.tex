...
% \keywords{Data streams, text classification, reproducibility, exactly once}
    ...
    \input{fs-anomalies-intro}


    \section{Background}
    \input{fs-anomalies-background}

    \section{Delivery guarantees}
    \input{fs-anomalies-guarantees}
    
    \section{Recovery mechanisms}
    \input{fs-anomalies-recovery}
    
    \section {Asynchronous snapshot anomaly}
    \input{fs-anomalies-anomaly}
    
    \section{Anomaly prevention}
    \input{fs-anomalies-prevention}
    
    \section{Conclusion}
    \input{fs-anomalies-conclusion}
