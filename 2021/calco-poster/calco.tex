...
\begin{abstract}
    ...
    Such specifications allow us to build equivalent graphs from custom both user-defined operations and SQL operators (TODO).
    We implement a graphs generation prototype and outline the challenges that we face regarding the optimization problem.
\end{abstract}
