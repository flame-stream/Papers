...
An operation can be described using two sorts of information: attributes that every data element has and properties of such attributes.
...
Semantics allows to write a simple definition of corresponding graphs and reduces their set to accelerate generation.
