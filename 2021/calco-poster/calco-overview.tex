...
Properties are just strings, like {\em "filteredDate"}.
...
Such graphs form a desired set of equivalent graphs.
Semantics allows to write simple definition of corresponding graphs and reduces their set to accelerate generation.
