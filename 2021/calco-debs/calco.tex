...
\begin{abstract}
    ...
    However, computational graph optimization is the thing that state-of-the-art stream processing engines (SPEs) still do not do in the ETL (extract, transform, load) use case.
