...
\begin{abstract}
    ...
    Distributed streaming processing is a common way to solve real-time data analysis and management objectives.
    However, computational graph optimization is the thing that state-of-the-art stream processing engines (SPEs) still do not do well.
    ...
    It provides significantly more information for SPE, hence it allows to generate all graphs with the same semantics to be able to choose the most optimal one.
    We demonstrate convenience for programmers to use this approach and feasibility to generate all graphs that solve a given problem.
