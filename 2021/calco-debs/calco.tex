...
\begin{abstract}
    ...
    The first one is more transparent for programmers, the second one has more optimization potential.
    Indeed, one declarative definition can have multiple concrete implementations, that allow to automatically choose the most optimal one if it is possible to evaluate them.

    Nowadays, there are two general ways to specify distributed dataflows: defining concrete graphs and streaming SQL.
